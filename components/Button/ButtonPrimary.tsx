...
const ButtonPrimary: FC<ButtonsPrimaryProps> = ({
  ...
  return (
    <button
      ...
      } text-white bg-gray-600 dark:bg-green-400 dark:hover:border-green-400  dark:opacity-50 duration-300 ease-in-out delay-150 hover:transition dark:text-slate-900 dark:hover:text-slate-200 dark:hover:bg-[#1e293b] ${btnStyles}`}
      disabled={disabled}
      {...props}
    >
      {children}
