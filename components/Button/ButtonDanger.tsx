...
const ButtonDanger: FC<ButtonDangerProps> = ({
  ...
  const btnStyles: string =
    "block px-3 py-1 mt-2 text-xs sm:text-sm border border-red-400  rounded-md tracking-widest focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150";
